...
Honestly, this was my first time using such framework and back then I used to use [ejs](https://npmjs.com/ejs) and thought that Javascript framework was bad and would slow down the performance.
