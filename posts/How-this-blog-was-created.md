...
This was an amazing experience, I've learnt a lot about Vue and Tailwind CSS. Yes I would like to give a shoutout to all the open source libraries, you can find them here at [README.md](https://github.com/leecheeyong/blog). 

Almost forgot about hosting, I'm currently using [Vercel](https://vercel.com) to host this application. Vercel is awesome
